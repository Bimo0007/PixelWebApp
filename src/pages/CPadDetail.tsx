  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen pt-[72px] overflow-hidden">
        <img src="/assets/cpad/hq720.jpg" alt="CPad" className="absolute inset-0 w-full h-full object-cover object-center" />
      </section>
